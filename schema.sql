...
returns trigger as $$
begin
  insert into public.profiles (id, full_name, avatar_url, library_name)
  values (new.id, new.raw_user_meta_data->>'full_name', new.raw_user_meta_data->>'avatar_url', new.raw_user_meta_data->>'library_name');
  return new;
end;
